...
cat system/system/priv-app/MiExtraPhotoGlobal/MiExtraPhotoGlobal.apk.* 2>/dev/null >> system/system/priv-app/MiExtraPhotoGlobal/MiExtraPhotoGlobal.apk
rm -f system/system/priv-app/MiExtraPhotoGlobal/MiExtraPhotoGlobal.apk.* 2>/dev/null
